...
export default function Navbar() {
  ...
  return (
    <>
      <header className="container relative z-40 mx-auto flex h-[72px] w-full items-center bg-white lg:h-[6rem]">
        <div
          ref={navRef}
      ...
      {isOpen && (
        <AnimatePresence>
          <div
            ...
            className="absolute bottom-0 left-0 right-0 top-0 z-50 bg-black bg-opacity-30"
          >
            <nav className="absolute top-[65px]  mx-auto w-[100vw] rounded border bg-white px-1">
              <motion.ul
                initial={{ opacity: 0 }}
                animate={{ opacity: 100 }}
                exit={{ opacity: 0 }}
